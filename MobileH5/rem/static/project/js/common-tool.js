...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FullScreenSelect = __webpack_require__(7);

	var _FullScreenSelect2 = _interopRequireDefault(_FullScreenSelect);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

	window.Loading = _Loading2['default'];
	window.Toast = _Toast2['default'];
	window.FullScreenSelect = _FullScreenSelect2['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _HtmlElementBuild2 = __webpack_require__(5);

	var _HtmlElementBuild3 = _interopRequireDefault(_HtmlElementBuild2);
	...
	var Loading = function (_HtmlElementBuild) {
	    _inherits(Loading, _HtmlElementBuild);
	    ...
	    function Loading() {
	        ...
	        var toastClassName = 'm-ifind-loading-wrapper';;
	        var div = _this.buildElement('div', toastClassName);
...
/***/ (function(module, exports) {
	...
	var HtmlElementBuild = function () {
	    function HtmlElementBuild() {
	        _classCallCheck(this, HtmlElementBuild);
	    }

	    _createClass(HtmlElementBuild, [{
	        key: 'buildElementText',
	        value: function buildElementText(text) {
	            text = text ? text : 'div';
	        ...
	        key: 'buildElement',
	        value: function buildElement(type, className, attributeList) {
	            type = type ? type : 'div';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Toast = function (_HtmlElementBuild) {
	    _inherits(Toast, _HtmlElementBuild);

	    function Toast(text, timer, position, type) {
	        ...
	        var id = 'ToastId' + ToastId;
	        var toastClassName = 'm-ifind-toast-wrapper';
	        var div = _this.buildElement('div', toastClassName, [{ name: "id", value: id }]);
...
/***/ (function(module, exports) {
	...
	var FullScreenSelect = function () {
	    function FullScreenSelect(options) {
	        _classCallCheck(this, FullScreenSelect);
	    ...
	    _createClass(FullScreenSelect, [{
	        key: "build",
	        value: function build() {
	            FullScreenSelectId++;
	            var body = document.querySelector("body");
	            this.id = "fullScreenSelect" + FullScreenSelectId;
	            var div = this.buildElement('div', ['full-screen-select', 'ifind-hide'], [{ name: "id", value: this.id }]);

	            var ul = this.buildElement('ul');

	            if (this.data) for (var t = 0; t < this.data.length; t++) {
	        ...
	        value: function bind() {
	            ...
	            this.dom.on("click", "li", function (t) {
	                ...
	                e.dom.find("li.full-select-option-selected").removeClass("full-select-option-selected"), $(this).addClass("full-select-option-selected"), e.options.afterSelectedFun({
	                    name: i,
	                    key: l
	                }), e.hide();
	        ...
	        key: "restData",
	        value: function restData(e) {
	            this.options.data = e, this.data = e, this.defalutValue = this.data[0], this.dom.remove(), this.build(), this.bind();
	        }
	    }, {
	        key: "val",
	        value: function val(e) {
	            for (var t = this.dom.find("li"), l = 0; l < t.length; l++) {
	                t[l].getAttribute("data-value") == e && (this.defalutValue = e, this.dom.find("li.full-select-option-selected").classList.remove("full-select-option-selected"), t[l].classList.add("full-select-option-selected"));
	            }
	        }
	    }]);
